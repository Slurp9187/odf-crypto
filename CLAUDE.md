...
| Changelog invariants, the open/cut release flow, tag mechanics | [`.claude/skills/odf-crypto-changelog-protocol/SKILL.md`](.claude/skills/odf-crypto-changelog-protocol/SKILL.md) |
